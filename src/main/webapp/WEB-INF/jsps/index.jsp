        ...
        <div class="col-12">
          ...
          <!-- Video Overview -->
            <div class="video-overview">
              <a href="https://www.youtube.com/watch?v=vyovZc7uEqM" class="video--play--btn"><i class="fa fa-play" aria-hidden="true"></i> #GatewayToSecureIndia</a>
            </div>
            <h2>Sustainability | Speed and Customer Centric | Technology Driven</h2>
            <!--<a href="#" class="btn fancy-btn fancy-active">About Us</a> -->
            <a href="login.jsp" class="btn fancy-btn">Invoice Manager</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row no-gutters">
              <div class="col-12 col-md-4">
                <div class="single-top-feature">
                  <h5><i class="fa fa-inr" aria-hidden="true"></i>  Sustainable Value Creation</h5>
                  <p>Adani Group creates report annually, this report presents the sustainability performance and value creation story of APL 
                    on material topics. </p>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="single-top-feature">
                  <h5><i class="fa fa-ship" aria-hidden="true"></i>  Integrated Logistics</h5>
                  <p>Its tech-driven innovations have seen the Adani Group company become the first port operator in India to log traffic of 200 MT in a fiscal year. </p>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="single-top-feature">
                  <h5><i class="fa fa-building" aria-hidden="true"></i>  Our Businesses</h5>
                  <p>APSEZ represents a large network of ports with India's largest SEZ. APSEZ Port Business is 
                    India's Largest private port operator with presence across 10 locations </p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-12 col-lg-6">
          <div class="about-us-text">
            ...
            <p>Being one of the greenest port operators in the world, we are extremely mindful of resourceful habitat creation and have taken huge initiatives 
              for mangrove preservation and environment conservation.</p>
            <a href="#" class="btn fancy-btn fancy-dark">View More</a>
          </div>
        </div>
          ...
          <div class="testimonials-slides owl-carousel">
            ...
            <div class="single-testimonial d-md-flex align-items-center">
              ...
              <div class="testimonilas-content">
                ...
                <h5>Our customers are the most important element of Port business and we are aligned and attuned to their needs and utmost satisfaction at 
                  all times. The state-of-the-art technology driven infrastructure, coupled with high level of automation and intense focus on time management 
                  in port and vessel operations ensures delighted customers.</h5>
                <h6>Karan Adani - <span>CEO</span></h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-4">
          <div class="single-blog-area wow fadeInUp" data-wow-delay="0.5s">
            ...
            <div class="blog-content">
              <h5><a href="static-page.jsp">We Create Experiences</a></h5>
              <p>The Fancy that recognize the talent and effort of the best web designers, developers and agencies in the world.</p>
              <a href="static-page.jsp">Learn More</a>
            </div>
          </div>
        </div>
        <!-- Single Blog -->
        <div class="col-12 col-md-4">
          <div class="single-blog-area wow fadeInUp" data-wow-delay="1s">
            ...
            <div class="blog-content">
              <h5><a href="static-page.jsp">Simple, Fast And Fun</a></h5>
              <p>The Fancy that recognize the talent and effort of the best web designers, developers and agencies in the world.</p>
              <a href="static-page.jsp">Learn More</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-4">
          <div class="single-blog-area wow fadeInUp" data-wow-delay="1.5s">
            ...
            <div class="blog-content">
              <h5><a href="static-page.jsp">Device Friendly</a></h5>
              <p>The Fancy that recognize the talent and effort of the best web designers, developers and agencies in the world.</p>
              <a href="static-page.jsp">Learn More</a>
            </div>
          </div>
